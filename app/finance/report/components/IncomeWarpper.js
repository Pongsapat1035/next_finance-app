...
export default function IncomeWarpper() {
    return (
        <Grid2 container direction="column" gap={2} size={4} sx={{ bgcolor: 'primary.light', borderRadius: '15px', p: 3 }}>
            ...
            <Stack direction="row" height="10px" borderRadius={20} overflow="hidden" gap="2px">
                <Box sx={{ width: "30%", bgcolor: 'red', height: '10px' }}></Box>
                <Box sx={{ width: "30%", bgcolor: 'orange', height: '10px' }}></Box>
                <Box sx={{ width: "40%", bgcolor: 'blue', height: '10px' }}></Box>
            </Stack>
